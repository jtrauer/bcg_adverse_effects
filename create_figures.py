...
bettag_axis = reactivation_graph.add_subplot(231, title="Lincoln state school", xlim=(0, x_limit), ylim=(0, y_limit),
                                             ylabel="Age")
...
# madanapalle
frimodt_axis = reactivation_graph.add_subplot(232, title="Madanapalle", xlim=(0, x_limit), ylim=(0, y_limit))
...
# ferguson plot
ferguson_axis = reactivation_graph.add_subplot(233, title="Saskatchewan", xlim=(0, x_limit), ylim=(0, y_limit),
...
# rosenthal plot
rosenthal_axis = reactivation_graph.add_subplot(234, title="Chicago, hospital", xlim=(0, x_limit), ylim=(0, y_limit),
                                                xlabel="Time from vaccination")
...
chicago_nursing_axis = reactivation_graph.add_subplot(235, title="Chicago, nursing", xlim=(0, x_limit),
                                                      ylim=(0, y_limit))
